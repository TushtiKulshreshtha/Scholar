// This component contains information about -----> switch tabs and form 
...
const RenderSteps = () => {
    ...
    // using slice for step value initial ---> 1
    ...
    return (
        <>
            {/* Render UI According to step value  */}
            <div className="relative mb-2 flex w-full justify-center">
                {
                    steps.map( (item) => (
                        // compare steps id with step slice to highlight
                        <>
            ...
            {/* Render Steps Text According to step values ie 1,2,3 */}
